...
- Source: `artifacts/checkpoint_runs/checkpoint_20260331_182606/REPORT.md`
- Source: `artifacts/checkpoint_runs/checkpoint_20260331_182606/checkpoint_result.json`

## C2. Multi-interface attribution is validated (`lo0` and `en0`)
- Source: `artifacts/checkpoint_runs/checkpoint_20260331_182606/checkpoint_result.json` (CT2 detail)
- Source: `artifacts/checkpoint_runs/checkpoint_20260331_182606/derived_metrics.json` (`interface_counts`)
...
- Source: `scripts/checkpoint/CHECKPOINT_SUPER_DETALHADO.md`
